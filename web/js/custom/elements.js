	...
	**/
	...
	jQuery("#slider2").slider({
			...
			slide: function(event, ui) {
				jQuery("#amount").text("jQuery"+ui.value);
			}
	});
	jQuery("#amount").text("jQuery" + jQuery("#slider").slider("value"));
	...
	jQuery("#slider3").slider({
		...
		values: [ 75, 300 ],
		slide: function( event, ui ) {
			jQuery("#amount2").text("jQuery" + ui.values[ 0 ] + " - jQuery" + ui.values[ 1 ]);
		}
	});
	jQuery("#amount2").text("jQuery" + jQuery("#slider3").slider("values", 0) +
			" - jQuery" + jQuery("#slider3").slider("values", 1));
	...
	jQuery("#slider4").slider({
			...
			max: 100,
			slide: function( event, ui ) {
				jQuery("#amount4").text("jQuery" + ui.value);
			}
	});
	jQuery("#amount4").text("jQuery"+jQuery("#slider4").slider("value"));
	...
	jQuery("#slider5").slider({
			...
			max: 100,
			slide: function(event, ui) {
				jQuery("#amount5").text("jQuery"+ui.value);
			}
	});
	jQuery("#amount5").text("jQuery"+jQuery("#slider5").slider("value"));
	...
	jQuery("#slider7").slider({
			...
			values: [17, 67],
			slide: function(event, ui) {
				jQuery("#amount7").text("jQuery"+ui.values[0]+"-jQuery"+ui.values[1]);
			}
		});
	jQuery("#amount7").text("jQuery"+jQuery("#slider7").slider("values",0) +
			" - jQuery"+jQuery("#slider7").slider("values",1));
